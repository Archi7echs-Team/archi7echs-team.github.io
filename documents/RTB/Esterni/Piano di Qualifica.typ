...
#show: conf.with(
  ...
  outline_depth: 2,
  changelog: (
    "0.3.2", "30-01-2025", "Aggiornamento tabelle test", p.valdagno, "",
...
#align(center)[
  ...
  [T.S.25], [Verificare che l'utente possa opacizzare i soli dati che sono maggiori della media globale, tramite un apposito bottone],[F.1.21] ,[NI],
