...
#align(center)[
  ...
  [T.S.11], [Verificare che l'utente possa, mediante spostamento del mouse sopra il grafico, ruotare la visualizzazione],[F.1.7] ,[NI],
  [T.S.12], [Verificare che l'utente possa, mediante spostamento del mouse sopra il grafico, muoversi solo orizzontalmente come se fosse in un ambiente 2D],[F.1.8] ,[NI],
  [T.S.13], [Verificare che l'utente possa, mediante spostamento del mouse sopra il grafico, muoversi solo verticalmente come se fosse in un ambiente 2D],[F.1.9] ,[NI],
  [T.S.14], [Verificare che l'utente possa, attraverso le gesture del mouse, ingrandire o ridurre liberamente la visualizzazione],[F.1.10] ,[NI],
  ...
  [T.S.29], [Verificare che l'utente possa visualizzare all'interno del grafico gli N dati (barre) con valore più alto, opacizzando gli altri],[F.1.25] ,[NI],
  [T.S.30], [Verificare che l'utente possa visualizzare all'interno del grafico gli N dati (barre) con valore più basso, opacizzando gli altri],[F.1.26] ,[NI],
