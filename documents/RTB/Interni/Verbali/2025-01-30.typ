...
#show: conf.with(
  ...
  outline_depth: 1,
  changelog: (
    "0.1.0", "05-02-2025",  "Prima stesura documento", p.salvo, "",
  )
)

_Per discutere su come procedere in questo periodo d'esami e per ruotare i ruoli si decide di convocare una riunione per discutere di quanto segue:_
...
== Discussione su periodo passato e periodo futuro
Il gruppo discute di come gestire il prossimo periodo e su ciò che è stato fatto nel periodo passato, il lavoro ha subito un rallentamento a causa dell'inizio della sessione universitaria che ha portato un generale rallentamento. Il rallentamento era stato preventivato ed è stato affrontato in modo adatto. L'obiettivo del team in questo prossimo periodo è una revisione generale dei documenti e candidatura per incontro #glossario("RTB") con il #p.cardin. Inoltre #p.lucato propone alcuni cambiamenti nel nome dei documenti per maggiore chiarezza, decisione accolta dal team. inoltre vengono identificati molteplici fix da eseguire.
...
Si convoca il prossimo incontro per con giorno e orario da stabilire per discutere di quanto svolto
...
#decisioni((
  ...
  [1],[Fix generale],[I problemi identificati verranno risolti e si effettuera una revisione globale],
  [2],[Continuazione stesura documenti],[I compiti verranno passati e si continuera con il miglioramento di documenti, #glossario("sito") e #glossario("PoC")],
  ))
...
#todo((
  ...
  (190,), (p.scandaletti), [Fix #glossario("Sito"): sezione contatti],
  (191,), (p.checchinato), [Fix #glossario("Glossario"): caratteri speciali],
  ...
  (199,), ("Il team"), [Revisione grammaticale e sintattica documentazione],
))
